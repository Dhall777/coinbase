...
Eventually, this app will also store price data in PostgreSQL and chart the prices on a 'live-dashboard', while allowing authenticated users to place crypto trade orders.
